...
angular.module("PlantsApp").run([ "$templateCache", function($templateCache) {
    ...
    $templateCache.put("app/components/photo/scrollerPopover.html", '<ion-modal-view class=photo-gallery><ion-slide-box show-pager=false><ion-scroll zooming=true direction=xy style="width:100%; height:100%"><ion-slide ng-repeat="image in images"><img ng-src={{image}}></ion-slide></ion-scroll></ion-slide-box></ion-modal-view>');
